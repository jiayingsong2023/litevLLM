...
| DeepSeek-V4-Flash-IQ2XXS-w2Q2K-AProjQ8-SExpQ8-OutQ8-chat-v2-imatrix.gguf | Experimental | Native DS4 GGUF bring-up target. Metadata/config detection, inspect-only weight binding, paged compressed KV contracts, model registry, loader routing, and OpenAI REST route smoke are present; full forward execution is not wired yet. |
