...
def run_qwen_lora_benchmark(batch_size=32, rank=16):
    print(f"=== QWEN3.5-9B + LORA PERFORMANCE AUDIT: BS={batch_size}, Rank={rank} ===")
    ...
    # 2. Inject LoRA into ALL compatible layers
    print(f">>> Injecting Rank-{rank} Adapters into all layers...")
    inject_count = 0
    ...
    print(f"\n======================================")
    print(f"QWEN-LORA BS={batch_size} RESULT")
...
if __name__ == "__main__":
    run_qwen_lora_benchmark(batch_size=32)
