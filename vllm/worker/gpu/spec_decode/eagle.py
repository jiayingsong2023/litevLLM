...
from vllm.attention.backend import AttentionMetadataBuilder
...
from vllm.worker.gpu.input_batch import InputBatch, InputBuffers
from vllm.worker.gpu.sample.gumbel import gumbel_sample
from vllm.worker.gpu.spec_decode.eagle_cudagraph import EagleCudaGraphManager
