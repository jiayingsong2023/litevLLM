...
from vllm.v1_utils import compute_iteration_details, report_usage_stats
from vllm.worker.worker_base import WorkerBase
from vllm.worker.workspace import init_workspace_manager
...
class Worker(WorkerBase):
    ...
    def init_device(self):
        ...
        if self.use_v2_model_runner:
            from vllm.worker.gpu.model_runner import GPUModelRunner as GPUModelRunnerV2
            self.model_runner: GPUModelRunner = GPUModelRunnerV2(self.vllm_config, self.device) # type: ignore
        else:
            from vllm.worker.gpu_model_runner import GPUModelRunner as GPUModelRunnerV1
