...
class DeepseekV32IndexerCache: pass
...
from vllm.attention.backends.tree_attn import (
...
from vllm.sample.sampler import _SAMPLING_EPS
from vllm.spec_decode.metadata import SpecDecodeMetadata
from vllm.spec_decode.utils import (
    eagle_prepare_inputs_padded_kernel,
    eagle_prepare_next_token_padded_kernel,
)
from vllm.v1_utils import CpuGpuBuffer
from vllm.worker.dp_utils import coordinate_batch_across_dp
...
class SpecDecodeBaseProposer:
    def __init__(
        ...
        if current_platform.is_rocm():
            from vllm.attention.backends.rocm_attn import RocmAttentionMetadata
            ...
            if find_spec(
                ...
                from vllm.attention.backends.rocm_aiter_fa import (
            ...
            from vllm.attention.backends.flex_attention import FlexAttentionMetadata
