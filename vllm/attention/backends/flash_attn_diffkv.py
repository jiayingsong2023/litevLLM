...
from vllm.attention.backends.fa_utils import is_flash_attn_varlen_func_available
from vllm.attention.ops.triton_reshape_and_cache_flash import (
    triton_reshape_and_cache_flash_diffkv,
)

if is_flash_attn_varlen_func_available():
    from vllm.attention.backends.fa_utils import flash_attn_varlen_func
from vllm.logger import init_logger
from vllm.attention.backends.utils import get_kv_cache_layout
