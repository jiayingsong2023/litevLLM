...
from vllm.metrics.perf import PerfStats
from vllm.spec_decode.metrics import SpecDecodingStats

if TYPE_CHECKING:
    from vllm.engine.v1 import EngineCoreEvent, EngineCoreOutput, FinishReason
...
class IterationStats:
    ...
    def update_from_events(
        ...
        from vllm.engine.v1 import EngineCoreEventType
