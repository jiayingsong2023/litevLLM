...
FASTINFERENCE_ENV_REGISTRY: dict[str, FastInferenceEnvSpec] = {
    ...
    "FASTINFERENCE_DEEPSEEK_V4_FLASH_INDEXER_SELECT_FALLBACK": _tool_only(
        "FASTINFERENCE_DEEPSEEK_V4_FLASH_INDEXER_SELECT_FALLBACK"
    ),
    "FASTINFERENCE_DEEPSEEK_V4_FLASH_INDEXER_TOP_K": _tool_only(
        "FASTINFERENCE_DEEPSEEK_V4_FLASH_INDEXER_TOP_K"
    ),
    ...
    "FASTINFERENCE_DEEPSEEK_V4_FLASH_ROUTER_TOP_K": _tool_only(
        "FASTINFERENCE_DEEPSEEK_V4_FLASH_ROUTER_TOP_K"
    ),
    "FASTINFERENCE_DEEPSEEK_V4_FLASH_STAGING_BUDGET_GB": _tool_only(
