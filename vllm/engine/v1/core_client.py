...
from vllm.engine.v1.core import EngineCore, EngineCoreProc
from vllm.engine.v1.exceptions import EngineDeadError
from vllm.engine.v1.utils import (
    CoreEngineActorManager,
    CoreEngineProcManager,
    launch_core_engines,
)
from vllm.executor import Executor
from vllm.serial_utils import MsgpackDecoder, MsgpackEncoder, bytestr
...
class InprocClient(EngineCoreClient):
    ...
    def get_output(self) -> EngineCoreOutputs:
        ...
        return outputs or EngineCoreOutputs()
