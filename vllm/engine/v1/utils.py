...
from vllm.v1_utils import get_engine_client_zmq_addr, shutdown
...
class CoreEngineActorManager:
    ...
    def __init__(
        ...
        from vllm.engine.v1.core import DPMoEEngineCoreActor, EngineCoreActor
...
def launch_core_engines(
    ...
    with zmq_socket_ctx(
        ...
        from vllm.engine.v1.core import EngineCoreProc
